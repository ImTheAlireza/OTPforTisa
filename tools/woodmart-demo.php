...
HTML;
	...
	$body = $drawer(
		...
		'بدون سیگنا',
		$before,
		'فرم ورود معمولی وودمارت، با نام کاربری و رمز عبور.'
	);

	$body .= $drawer(
		'wm-after',
		'با سیگنا، به‌جای فرم قبلی',
		$after,
		'فرم سیگنا جای فرم ورود وودمارت را می‌گیرد. دکمهٔ «ایجاد حساب کاربری» هم برداشته می‌شود، چون عضویت از همین فرم انجام می‌شود.'
	);

	$body .= $drawer(
		'wm-alongside',
		'با سیگنا، کنار فرم قبلی',
		$alongside,
		'اگر بخواهید ورود با رمز عبور هم بماند، فرم سیگنا زیر فرم قبلی قرار می‌گیرد.'
	);
...
<title>کشوی ورود وودمارت | دموی سیگنا</title>
<!--
...
<main>
	<section class="wm-lead">
		<h1>سیگنا در کشوی ورود وودمارت</h1>
		<p>
			اگر قالب سایتتان وودمارت است، سیگنا خودش داخل کشوی ورود قرار می‌گیرد و لازم نیست به فایل‌های قالب
			دست بزنید.
		</p>
		<p>
			اینجا سه حالت را کنار هم گذاشته‌ایم. روی سایت واقعی، یکی از دو حالت سیگنا را در تنظیمات انتخاب
			می‌کنید.
		</p>
	</section>
