...
final class MeliPayamak extends HttpGateway {
	...
	public function plan(): array {
		...
		if ( '' === $sender ) {
			$issues[] = __( 'شماره فرستنده تنظیم نشده است؛ پنل ملی پیامک بدون آن پیام را رد می‌کند.', 'signa' );
		}
		...
		return array(
			...
			'issues'   => $issues,
			'notes'    => array( __( 'اگر حساب شما فقط الگو (Pattern) دارد، ارسال متنی آزاد کار نمی‌کند.', 'signa' ) ),
		);
	}
