	...
	private function whatsNew(): void {
		$this->card(
			...
			function () {
				...
				echo '<li>' . esc_html__( 'رفع خطای مرگبار نسخهٔ ۱.۳.۲ (ArgumentCountError) که سایت را از کار می‌انداخت.', 'tisa-otp' ) . '</li>';
				echo '<li>' . esc_html__( 'اگر بخشی از افزونه بالا نیاید، دیگر سایت سفید نمی‌شود: پیام فارسی در پیشخوان و بقیهٔ سایت سالم می‌ماند.', 'tisa-otp' ) . '</li>';
				echo '<li>' . esc_html__( 'افزونه خودش را می‌سنجد: اگر فایل‌های نصب‌شده از دو نسخهٔ مختلف باشند، نام همان فایل‌ها را نشان می‌دهد.', 'tisa-otp' ) . '</li>';
				...
				echo '<li>' . esc_html__( 'دکمهٔ «حالت اپ» در نوار بالای همین صفحه: تمام‌صفحه و بدون منو و نوار مدیریت وردپرس. با همان دکمه برمی‌گردید.', 'tisa-otp' ) . '</li>';
				echo '</ul>';
