 ...
 *
 * Everything the browser needs lives under `tisa-otp/v1`, which keeps the flow
			...
			try {
				...
				return new \WP_REST_Response(
					array(
						'success' => false,
						'code'    => 'server_error',
						'message' => __( 'خطای غیرمنتظره در پردازش درخواست. لطفاً دوباره تلاش کنید.', 'tisa-otp' ),
