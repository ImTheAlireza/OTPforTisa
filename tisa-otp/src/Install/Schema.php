...
final class Schema {
	...
	public function codes(): string {
		return $this->table( 'tisa_otp_codes' );
	}

	public function state(): string {
		return $this->table( 'tisa_otp_state' );
	}

	public function logs(): string {
		return $this->table( 'tisa_otp_logs' );
	}
	...
	public function install(): void {
		...
		update_option( 'tisa_otp_db_version', self::DB_VERSION, false );
	}
