...
final class Report {
	...
	public static function label( string $event ): string {
		$labels = array(
			self::SENT                    => __( 'کد ارسال شد', 'tisa-otp' ),
			self::FAILED                  => __( 'ارسال ناموفق', 'tisa-otp' ),
			self::REJECTED                => __( 'رد توسط محافظ‌ها', 'tisa-otp' ),
			self::CREATED                 => __( 'حساب تازه', 'tisa-otp' ),
			'gateway.failed'              => __( 'خطای سامانه پیامکی', 'tisa-otp' ),
			'captcha.rejected'            => __( 'کپچا رد شد', 'tisa-otp' ),
			'captcha.transport_failed'    => __( 'کپچا پاسخ نداد', 'tisa-otp' ),
			'registration.failed'         => __( 'عضویت ناتمام', 'tisa-otp' ),
			'user.create_failed'          => __( 'ساخت حساب ناموفق', 'tisa-otp' ),
			'lookup.ambiguous'            => __( 'شماره روی چند حساب', 'tisa-otp' ),
			'gateway.failover_used'       => __( 'استفاده از سامانه پشتیبان', 'tisa-otp' ),
			'gateway.breaker_skipped'     => __( 'سامانه کنارگذاشته‌شده', 'tisa-otp' ),
			'guard.trusted_skip'          => __( 'معافیت شماره مورد اعتماد', 'tisa-otp' ),
			'session.blocked_role'        => __( 'نقش مسدود‌شده', 'tisa-otp' ),
			'import.finished'             => __( 'واردسازی تمام شد', 'tisa-otp' ),
		);
